            ...
            <div className="flex flex-col w-[300px] h-[350px] m-auto mt-15 rounded-[35px] bg-white overflow-hidden">
                ...
                <div className="h-full flex flex-col justify-between p-5">
                    <div className="flex justify-between items-center">
                        <div className="font-gilroy-bold text-lg">Name</div>
                        <input className="h-10.25 box-border py-2.5 border-1 border-[#D5D5D5] rounded-[10px] font-gilroy text-lg text-center" 
